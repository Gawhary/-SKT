...
double GetElapsedSeconds(void)
{
  ...
  double seconds =  ((double)currentTime.QuadPart - (double)s_lastTime.QuadPart) / (double)m_ticksPerSecond.QuadPart;
...
double GetElapsedMicroSeconds(void)
{
	static LARGE_INTEGER s_lastTime = m_startTime;
	LARGE_INTEGER currentTime;
	...
	return seconds * 1000000.0/*Million*/;
} // end GetElapsedSeconds()

double GetElapsedNanoSeconds(void)
{
	static LARGE_INTEGER s_lastTime = m_startTime;
	LARGE_INTEGER currentTime;
	...
	return seconds * 1000000000.0/*Milliard*/;
} // end GetElapsedSeconds()
